var datasets = [
    {
        ...
        dataEnt: d3.csv('https://cdn.jsdelivr.net/gh/SamStorr/SeguridadViaCivil/agresiones_ent_2007-2023.csv', function(d){
            return {
                anio: +d.anio,
                cve: d.ent,
                aut: d.aut,
        ...
        dataMun: d3.csv('https://cdn.jsdelivr.net/gh/SamStorr/SeguridadViaCivil/agresiones_mun_2007-2023.csv', function(d){
            return {
                anio: +d.anio,
                ent: d.ent,
                cve: d.ent + d.mun,
    ...
    {   nombre: "Homicidios",
        autoridades: false,
        dataEnt: d3.csv('https://cdn.jsdelivr.net/gh/SamStorr/SeguridadViaCivil/homicidios_ent_2015-2022.csv', function(d){return {
            anio: +d.anio,
            cve: d.ent,
            abs: {
                    tot: {
        ...
        dataMun:     d3.csv('https://cdn.jsdelivr.net/gh/SamStorr/SeguridadViaCivil/homicidios_mun_2015-2022.csv', function(d){return {
            anio: +d.anio,
...
const geoFiles =  [d3.json('https://cdn.jsdelivr.net/gh/SamStorr/SeguridadViaCivil/entidades.json'), d3.json('https://cdn.jsdelivr.net/gh/SamStorr/SeguridadViaCivil/00mun-11.json'), datasets[0].dataEnt, datasets[0].dataMun]
